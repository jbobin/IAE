...
class IAE(object):
    ...
    def __init__(self,fulltensor=False,resnet=False, Model=None, fname='IAE_model', AnchorPoints=None, NSizeIn=None, NSizeOut=None, active_forward='mish',
...
#################################
    ...
    def barycentric_span_projection(self, X, Lambda=None, Amplitude=None, niter=None, optim=None, step_size=None,norm='1'):
